    ...
    <div className="bg-[#FDEE21] py-16 px-6 md:px-16 flex flex-col md:flex-row-reverse items-center justify-between">
      ...
      <div className="max-w-xl text-black">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <button className="flex items-center justify-center gap-2 bg-black text-[#FDEE21] px-6 py-3 rounded-lg font-medium hover:opacity-90 w-full sm:w-auto">
            <FaSearch /> Explore Jobs
          </button>

          <button className="flex items-center justify-center duration-700 cursor-pointer ease-in-out gap-2 border border-black px-6 py-3 rounded-lg hover:bg-black hover:text-[#FDEE21] w-full sm:w-auto">
            <FaBriefcase /> Post a Business
          </button>
