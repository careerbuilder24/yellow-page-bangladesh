...
//             <h2 className="text-5xl font-bold text-yellow-500 mt-2 leading-tight">
...
//             <h3 className="bg-yellow-500 text-white text-center py-2 rounded-lg mb-6 font-semibold">
//               Campaign Features
//             </h3>
